...
import { ProfileCardDesktop, ProfileCardNotAuthDesktop, Reviews } from '~/entities/user';

import { useAuth } from '~/shared/hooks';
import { Rating } from '~/shared/ui/Rating';
import { STag } from '~/shared/ui/STag';

export function ProfileMePageDesktop() {
  ...
  return (
    <Box>
      ...
      {userId ? <ProfileCardDesktop userId={userId} /> : <ProfileCardNotAuthDesktop />}
