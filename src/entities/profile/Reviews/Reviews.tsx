  ...
  return (
    <VStack align="stretch" spacing={0} p={4} mb={4} borderRadius="2xl" bg="white">
      <Flex align="center" justifyContent="space-between">
        <Text color="gray.600">3 сентября 2022</Text>
      ...
      <Flex direction="column" py={3} gap={1}>
        <Text fontSize="sm" fontWeight="medium" lineHeight="120%">
          Михаил Шафутинский
        </Text>
        ...
        <Flex align="center" gap={1}>
          <Link lineHeight="120%">Сервис онлайн-образования</Link>
          <Icon as={FiArrowUpRight} w="16px" h="16px" />
        </Flex>
      </Flex>
      <Text>
